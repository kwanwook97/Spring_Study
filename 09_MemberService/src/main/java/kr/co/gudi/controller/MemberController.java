...
public class MemberController {
	 ...
	 * 
	 * @RequestMapping("/") public String loginForm() { return "login"; }
	 * 
	 * @RequestMapping("/joinForm") public String joinForm() { return "join"; }
	 * 
	 * @RequestMapping(value="join", method = RequestMethod.POST) public String
	 * join(@RequestParam Map<String, String> param, Model model) {
	 * logger.info("params : {}", param); // 위에서 Autowried를 사용했기 때문에 객체화할 필요가 없다!!
	 * String msg = service.join(param); model.addAttribute("result", msg); return
	 * "login"; }
	 */
