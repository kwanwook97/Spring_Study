...
<jsp:include page="loginbox.jsp"/>
	<form action="update.do" method="post" entype="multipart/form-data">
		...
		<table>
			...
			<tr>
				<th>제목</th>
				<td><input type="text" name="subject" value="${info.subject}"/>
				</td>
			</tr>
			<tr>
				<th>내용</th>
			...
			<tr>
				<th>이미지</th>
				<td>
				<!-- /photo라는 요청이 있으면 C:/upload로 연결하도록 설정되어야 함(server.xml) -->
